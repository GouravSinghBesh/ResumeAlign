...
const resume = () => {
    ...
    useEffect(() => {
        const loadResumeData = async () => {
            ...
            console.log('feedback', resumeURL, imageURL, data.feedback);
    ...
    return (
        <main>
            ...
            <div className='flex flex-row w-full max-lg:flex-col-reverse'>
                <section className="feedback-section bg-[url('/images/bg-small.svg') bg-cover h-full sticky top-0 items-center justify-center">
                    {imageURL && resumeURL && (
